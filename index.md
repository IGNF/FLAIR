    ...
    <thead>
      <tr>
        ...
        <th colspan="2" style="text-align: center; padding: 2% 8%;">
          ...
          We are committed to supporting research and fostering innovation in the fields of Earth Observation. For any question concerning the data, their access and exploitation, as well as for any idea of future datasets or suggestion of topics, simply contact us at the address:<br>
      ...
      <tr>
        ...
        <td colspan="2" style="text-align: center; padding: 3% 8%;">
          <p style="font-size: 1.05em; line-height: 1.6em;">
            ...
            <a href="https://www.etalab.gouv.fr/wp-content/uploads/2018/11/open-licence.pdf" target="_blank"><strong>Open Licence 2.0</strong></a> from Etalab.<br>
...
">
  <!-- Card 1 -->
  <div style="background: transparent; border-radius: 10px; overflow: hidden; height: 260px; display: flex; align-items: center; justify-content: center;">
